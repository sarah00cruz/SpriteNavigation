...
const D_KEY = 68;
const A_KEY = 65;
avatars[2] = new Avatar("Sarah", 300, 150, 'assets/ghost1.png', 'assets/ghost3.png');

function preload() {
  starImg = loadImage('assets/fullStar.png');
  ghostImg = loadImage('assets/ghost1.png');
}
...
function setup() {
  ...
  ghostS.addAnimation('floating', 'assets/ghost1.png', 'assets/ghost3.png');
...
function draw() {
  ...
  // callback function
  ghost.overlap(ghostS, ghostCollision);
  //ghostS.overlap(star, ghostCollision);
...
function keyPressed() {
  if( key === ' ') {
    ...
    ghostS.position.x = width/2;
    ghostS.position.y = height/2;
  }
  // if(key === ' '){
  //   ghostS.position.x = width/2;
  //   ghostS.position.y = height/2;
...
function ghostCollision(spriteA, spriteB) {
  ...
  // ghostS.position.x = 100;
  // ghostS.position.y = 100;
